...
export const GithubSvg = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" id="github-icon" fill="white" color="#fff">
        <defs>
            <mask id="circle-fill-mask">
                <path
                    className="github-mask"
                    fill="white"
            ...
            <mask id="circle-outline-mask">
                <circle className="circle-outline" cx="50" cy="50" r="34.5"></circle>
            </mask>
        </defs>
        ...
        <g mask="url(#circle-fill-mask)">
            <circle className="circle-fill" cx="50" cy="50" r="30" stroke="black"></circle>
        </g>
    </svg>
)
